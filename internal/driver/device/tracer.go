...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang -target bpfel tracer ../../ebpf/tracer.bpf.c -- -I/usr/include/bpf -I.
...
func loadTacer() (*ebpf.CollectionSpec, error) {
	// Try to load from the compiled .o file in the ebpf directory
	paths := []string{
		"internal/ebpf/tracer.bpf.o",
		"../../ebpf/tracer.bpf.o",
		"/usr/share/tracer/tracer.bpf.o",
	}
